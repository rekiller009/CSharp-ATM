    ...
    public class Logic
    {
        ...
        public void UpdateAccount()
        {
            ...
            getUsername:
                ...
                // Get Status of Account (Active/Disabled)
        ...
        {
            // Creating a customer object to store value
            Customer customer = new Customer();
        ...
        getStatus:
            {
                ...
                {
                    Console.WriteLine("Wrong Input. Enteter \"Active\" & \"Disabled\"");
                    goto getStatus;
                }
        ...
        getOption:
            {
                ...
                getMin:
                    {
                        ...
                        // if user enters oter than number
                        catch (Exception)
                        {
                ...
                getMax:
                    ...
                    // Getting the list of custoemr objects from file
                    List<Customer> list = data.ReadFile<Customer>("customers.txt");
                    // Printing the result
                    Console.WriteLine("\n==== SEARCH RESULTS ====\n");
                    if (list.Count > 0)
        ...
        getOption:
            {
                ...
                try
                {
                    // Getting input if user wants Fash Cash or Normal Cash
                    string option = Console.ReadLine();
        ...
        getAmount:
            {
                Console.WriteLine("---- Transafer Cash ----\n");
